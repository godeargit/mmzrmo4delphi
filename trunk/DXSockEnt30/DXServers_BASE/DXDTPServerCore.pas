...
type
  TDXDTPServerCore = class(TDXServerCore)
  private
  protected
  public
{$IFDEF OBJECTS_ONLY}
...
///////////////////////////////////////////////////////////////////////////////
{$IFDEF OBJECTS_ONLY}
constructor TDXDTPServerCore.Create;
{$ELSE}
constructor TDXDTPServerCore.Create(AOwner:TComponent);
{$ENDIF}
begin
{$IFDEF OBJECTS_ONLY}
   inherited Create;
...
//         Destory this object.
///////////////////////////////////////////////////////////////////////////////
destructor TDXDTPServerCore.Destroy;
begin
  inherited Destroy;
end;
...
///////////////////////////////////////////////////////////////////////////////
procedure TDXDTPServerCore.ProcessSession(ClientThread:TDXServerThread);
begin
